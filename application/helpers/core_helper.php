<?php
    ...
    class core_sitio
    {
        public static function agregar($voto)
        {
            $CI =& get_instance();
            $CI->db->insert('votos', $voto);
        }

        public static function cargarVotos()
        {
            $CI =& get_instance();
        ...
        public static function cargarVoto($id)
        {
            $CI = & get_instance();
            $CI->db->where('ID', $id);
        ...
        public static function actualizarVoto($id, $voto)
        {
            $CI = & get_instance();
            $CI->db->where('ID', $id);
